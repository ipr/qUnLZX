...
Summary:
Unpacker-tool for LZX-compressed archive files.

Description:
Simple tool to view and unpack LZX-archives created (usually) on Amiga-computers.
...
Rewrite in C++ with Qt-based GUI.
